...
void GameStatePlayingData::Init()
{
    ...
    auto ball = std::make_shared<Ball>(sf::Vector2f(
        {SETTINGS.SCREEN_WIDTH / 2.f, SETTINGS.SCREEN_HEIGHT - SETTINGS.PLATFORM_HEIGHT - SETTINGS.BALL_SIZE / 2.f}));
...
void GameStatePlayingData::createBlocks()
{
    ...
    for (auto pairPosBlockTYpe : level.m_blocks)
    {
        ...
        sf::Vector2f position{(float)(SETTINGS.BLOCK_SHIFT + SETTINGS.BLOCK_WIDTH / 2.f +
