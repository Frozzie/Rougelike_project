...
Platform::Platform(const sf::Vector2f &position)
    : GameObject(SETTINGS.TEXTURES_PATH + TEXTURE_ID + ".png", position, (float)SETTINGS.PLATFORM_WIDTH,
...
void Platform::Move(float speed)
{
    ...
    position.x = std::clamp(position.x + speed, SETTINGS.PLATFORM_WIDTH / 2.f,
